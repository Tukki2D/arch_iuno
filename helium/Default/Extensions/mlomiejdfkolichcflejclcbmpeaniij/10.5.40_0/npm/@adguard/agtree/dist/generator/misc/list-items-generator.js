//#region node_modules/@adguard/agtree/dist/generator/misc/list-items-generator.js
/**
* Utility class for generating string representations of list items.
*/
var ListItemsGenerator = class ListItemsGenerator {
	/**
	...
	*/
	static generateListItem = (item) => {
		return `${item.exception ? "~" : ""}${item.value}`;
	};
	/**
